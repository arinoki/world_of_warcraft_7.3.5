...
L["Ancient Eredar Cache"] = "Baú Eredar Antigo"
L["Ancient Legion War Cache"] = "Baú de Guerra da Legião Antigo"
L["Eredar War Supplies"] = "Suprimentos de Guerra Eredares"
L["Felbloom"] = "Brotovil"
L["Fel-Bound Chest"] = "Baú Aviltado"
L["Forgotten Legion Supplies"] = "Suprimentos Esquecidos da Legião"
L["HandyNotes - Broken Shore"] = "HandyNotes - Argus"
L["Hide looted mobs"] = "Ocultar monstros saqueados"
...
L["Legion Treasure Hoard"] = "Grande Tesouro da Legião"
L["Legion War Supplies"] = "Suprimentos de Guerra da Legião"
L["Long-Lost Augari Treasure"] = "Tesouro Augari Perdido Há Tempos"
L["Others"] = "Outros"
L["Precious Augari Keepsakes"] = "Lembranças Augari Preciosas"
L["Query from server"] = "consulta de servidor"
...
L["Shows the POIs in Broken Shore"] = "Mostra os Pontos de Interesse em Argus"
...
L["Timeworn Fel Chest"] = "Baú Vil Envelhecido"
L["Void-Seeped Cache"] = "Baú Infectado pelo Caos"
L["What to display"] = "O que exibir"

-- ToC
L["Description"] = "Mostrar os Pontos de interesse em Argus"
L["Title"] = "HandyNotes - Argus"
